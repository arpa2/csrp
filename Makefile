...
test_srp11: test_srp11.c srp.c srp11.c
	...
	gcc -I /usr/local/src/SoftHSMv2/src/lib/cryptoki_compat/ -L /usr/local/lib/softhsm -Wl,-rpath=/usr/local/lib/softhsm -o test_srp11 test_srp11.c srp.c srp11.c -lsofthsm2 -lcrypto
